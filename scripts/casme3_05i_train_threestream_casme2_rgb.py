"""
05i_train_threestream_casme2_rgb.py -- Stage 3b: RGB + Flow + Depth three-stream model.
...
def run_one_fold(fold, df, label_map, epochs, overfit_test=False):
    ...
    patience = 8
    patience_counter = 0
    ckpt_path = Path(f"best_threestream_casme2_fold{fold}.pt") if not overfit_test else None
